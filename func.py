...
Original file is located at
    https://colab.research.google.com/drive/1eprMiVyhaytVJBZzD0Xrukgipa-0bR6E
"""
...
class BrazilMapPlotter:
    ...
    def plot(self):
        brazil = self.mpimg.imread(self.urllib.request.urlopen('https://i.pinimg.com/564x/81/6f/f6/816ff6ea17f5b4f5bb7c13d1082da74e.jpg'),'jpg')
